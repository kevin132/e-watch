...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark navbar-inner">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item active">
            ...
            <i class="far fa-user home-icon"></i>
        </li>
    </ul>
</nav>
<div class="overlay">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <video class="watch-video" autoplay loop muted data-setup="{}">
                    ...
                    Your browser does not support the HTML5 video tag. Try updating your browser or using a different
                    one.
                </video>
            </div>
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home"
           aria-selected="true">Louis Vuitton</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
           aria-selected="false">Tag heuer</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact"
           aria-selected="false">Armani</a>
    </li>
</ul>
            ...
            <div class="b-para-img-two d-flex justify-content-center flex-column">
                <div class="row no-gutters">
                    ...
                    <div class="col-6">
                        ...
                        <h3 class="prl-sub">
                            smart watches <br>  latest fashion statement
            ...
            <div class="b-para-img d-flex  justify-content-center flex-column">
                <div class="row no-gutters">
                    ...
                    <div class="col-6">
                        ...
                        <h3 class="prl-sub">wear your style<br> with verve & attitude</h3>
                        <a href="">
                            <button class="head-button ml-5 mt-4">View More</button>
                        </a>
                    </div>
...
<section id="home-men-ad">
    ...
    <h2 class="home-news-title text-center pt-5">Latest News</h2>
...
<section id="home-news">
    <h2 class="home-news-title text-center pt-4">subscribe to our newsletter</h2>
