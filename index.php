...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark navbar-inner">
     ...
     <ul class="navbar-nav">
          <li class="nav-item active">
               <div class="nav-ctn-bar">
                    <div class="nav-ctn-line"></div>
                    <div class="nav-ctn-line"></div>
                    <div class="nav-ctn-line"></div>
               </div>
          </li>
...
<section id="block-three">
     ...
     <h2 class="collection-subtitle">Tag Heure</h2>
     <div class="row no-gutters">
          <div class="col-lg-2">
     ...
     <a href="">
          <button class="three-button mt-5">View More</button>
     </a>
</section>
<!--end collection-->
...
<section id="home-news">
     <h2 class="home-news-title text-center pt-5">subscribe to our newsletter</h2>
     <form action="index.php" class="text-center">
          <label for="email">
               <input type="email" name="email" class="home-news-ipt text-center" placeholder="E-mail" />
          </label>
